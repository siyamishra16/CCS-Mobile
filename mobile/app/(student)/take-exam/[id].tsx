...
export default function TakeExamScreen() {
  ...
  async function fetchData() {
    try {
      ...
      const initialStates: QuestionState[] = examQs.map((_, i) => ({
  ...
  async function submitExam(auto: boolean) {
    ...
    try {
      ...
      console.log("insertPayload:", JSON.stringify(insertPayload));
      ...
      Alert.alert("Submit Error", e?.message ?? "Failed to submit exam.");
