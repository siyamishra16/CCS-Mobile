...
//         <TouchableOpacity onPress={() => router.back()}><Ionicons name="chevron-back" size={22} color="#1E293B" /></TouchableOpacity>
...
//           <TextInput style={styles.searchInput} placeholder="Search..." value={search} onChangeText={setSearch} placeholderTextColor="#94A3B8" />
//         </View>
//       </View>
...
//               style={styles.card} 
//               onPress={() => router.push({
//                 pathname: "/(student)/[categoryId]", // FIX: Folder structure match
//                 params: { categoryId: item.id, categoryName: item.name }
//               })}
//             >
//               <View style={styles.iconBox}><Text style={styles.iconText}>{item.name.charAt(0).toUpperCase()}</Text></View>
//               <View style={{ flex: 1, marginLeft: 12 }}>
//                 <Text style={styles.catName}>{item.name}</Text>
//                 <Text style={styles.catDesc} numberOfLines={1}>{item.short_description || "Assess your skills"}</Text>
//               </View>
...
//   searchBox: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#F1F5F9', borderRadius: 10, height: 44 },
...
//   iconBox: { width: 40, height: 40, borderRadius: 8, backgroundColor: '#EFF6FF', justifyContent: 'center', alignItems: 'center' },
//   iconText: { color: '#2563EB', fontWeight: 'bold', fontSize: 16 },
...
const BORDER_BLUE = "#BFDBFE"; // blue-200
const TEXT_DARK = "#222222"; // text-gray-22
...
const styles = StyleSheet.create({
  ...
  searchBox: { 
    ...
    height: 44,
    borderWidth: 1,
    borderColor: BORDER_BLUE // border-blue-200
  },
